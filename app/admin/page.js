...
export default function AdminPage() {
  ...
  const s={
    ...
    label:{display:'block',fontSize:11,color:'rgba(255,245,236,0.4)',fo',letterSpacing:1.5,textTransform:'uppercase',marginBottom:8},
    ...
    grid2:{display:'grid',gridTemplateColumns:'~fr 1fr',gap:'0 20px'},
