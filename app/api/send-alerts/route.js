      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#1a1510;border:1px solid rgba(255,92,58,0.2);border-radius:14px;overflow:hidden;">
        <tr><td style="padding:20px 24px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:16px;padding-top:14px;border-top:1px solid rgba(255,255,255,0.08);">
            <tr>
              <td><a href="https://yolofare.com/deals/${deal.id}" style="background:#FF5C3A;color:white;padding:10px 22px;border-radius:100px;font-size:13px;font-weight:600;text-decoration:none;display:inline-block;">View deal →</a></td>
...
<tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <tr><td style="background:linear-gradient(135deg,rgba(255,92,58,0.12) 0%,rgba(255,92,58,0.04) 100%);border:1px solid rgba(255,92,58,0.25);border-radius:20px;padding:32px;text-align:center;">
    ...
    <h1 style="margin:0 0 12px 0;font-size:26px;font-weight:800;color:#FFF5EC;letter-spacing:-1px;line-height:1.1;">✈️ ${isSingle?`New deal just dropped`:`${deals.length} new deals just dropped`}</h1>
    <p style="margin:0;font-size:15px;color:rgba(255,245,236,0.55);font-weight:300;">${isSingle?`${deal.destination} · ${deal.cabin_class} · Act fast`:`${deals.length} fresh deals · Book fast, deals expire`}</p>
  </td></tr>
  ...
  ${dealsHtml}
  <tr><td style="padding:8px 0 32px 0;text-align:center;"><a href="https://yolofare.com/deals" style="background:#FF5C3A;color:white;padding:16px 40px;border-radius:100px;font-size:16px;font-weight:700;text-decoration:none;display:inline-block;">View all deals →</a></td></tr>
  <tr><td style="border-top:1px solid rgba(255,255,255,0.08);padding:24px 0 0 0;text-align:center;">
    ...
    <p style="margin:0;font-size:12px;color:rgba(255,245,236,0.2);">© 2026 YoloFare · <a href="https://yolofare.com/preferences" style="color:rgba(255,92,58,0.6);text-decoration:none;">Update preferences</a></p>
  </td></tr>
...
export async function POST(request) {
  try {
    ...
    return Response.json({
      ...
      dealName: `${deal.origin_code} → ${deal.dest_code} · ${deal.destination}`,
    })
  } catch (error) {
